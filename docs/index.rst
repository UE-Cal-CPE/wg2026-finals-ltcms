...
|                                   | discipline process, and the false |
|                                   | escalation policy.                |
+-----------------------------------+-----------------------------------+
...
-  **Document every interaction.** A resolved ticket with incomplete
   ...
   review.
-  **Never ask a client for their password.** Direct them to
   self-service reset tools and document the interaction if they share
   credentials voluntarily.
-  **Security incidents are always Tier 3.** Any suspected breach,
   unauthorized access, or ransomware must be escalated immediately to
   ``#tier3-escalation`` — do not attempt to investigate or fix it
   yourself.
-  **SLA timers start when the client contacts us** — not when you see
   the message. Monitor your channels actively throughout your shift.
-  **When handling client data, do less — not more.** If you are unsure
   whether an action complies with data privacy regulations, stop and
   consult your Team Leader before proceeding.
